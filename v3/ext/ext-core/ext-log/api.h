extern int (*lprintf)(const char *msg); // [\1..\7] color escape codes. prints callstack if msg[0]=='!'
...
int (*lprintf)(const char *) = lprintf_;
...
UNITTEST {
    ...
    lprintf("\6--- new session ---\7" " " __DATE__ " " __TIME__);
}
#endif
