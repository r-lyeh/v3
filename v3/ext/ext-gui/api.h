...
extern int (*  ui_slider)(const char *txt, float *f, float minf, float maxf);
extern int (*  ui_float)(const char *txt, float *f);
...
int (*  ui_slider)(const char *txt, float *f, float minf, float maxf) = ui_slider_;
int (*  ui_float)(const char *txt, float *f) = ui_float_;
