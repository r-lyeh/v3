...
int main() {
    Vec2 ab = init(Vec2,1,2);
    Vec2 *cd = make(Vec2,3,4);
    Vec3 abc = init(Vec3,1,.z=2);
    Vec3 *def = make(Vec3);
    Vec3 *ghi = make(Vec3,.z=1,.y=2,.x=3);
