...
#define ctor(type,...)          ( &(ifdef(c,(type),type){__VA_ARGS__}) )
#define init(type,...)          ( *ctor(type, ( (void)sizeof(char [ offsetof(type,vt) == 0 ? 1 : -1 ]), (void*)((uintptr_t)type##_vt | 0) ), ##__VA_ARGS__))
#define make(type,...)          ( (type*)memcpy(malloc(sizeof(type)), ctor(type, ( (void)sizeof(char [ offsetof(type,vt) == 0 ? 1 : -1 ]), (void*)((uintptr_t)type##_vt | 1) ), ##__VA_ARGS__), sizeof(type)))
