...
void beep_(void) {
    ifdef(win32, system_async("rundll32 user32.dll,MessageBeep"); return; );
    ifdef(linux, system_async("paplay /usr/share/sounds/freedesktop/stereo/message.oga"); return; );
    ifdef(osx,   system_async("tput bel"); return; );
