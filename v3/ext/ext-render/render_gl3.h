void*     app_create_gl3(const char *appname, float scale); // @todo: app_create_gl3debug();
...
void* app_create_gl3(const char *appname, float scale) {
    RGFW_init();
    ...
    return app_create(appname, scale);
}
