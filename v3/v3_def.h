...
#elif !defined PATH_MAX && defined MAX_PATH
...
#define CALLOC  calloc   // memset0(malloc(sz)) static inline void* memset0(void *p) { return memset(p, 0, MSIZE(p)); }
#define FREE    free     // !(void)REALLOC((p),0)
#define MALLOC  malloc   // REALLOC(0, (sz))
#define MSIZE   ifdef(osx, malloc_size, ifdef(bsd, malloc_size, ifdef(win32, _msize, malloc_usable_size)))
//ifdef(android, size_t dlmalloc_usable_size(void*);)
//#if DEF(bsd) || DEF(osx)
...
#ifndef STRCMPI
#define STRCMPI ifdef(win32, _strcmpi, strcasecmp)
#ifndef _WIN32
#include <strings.h>
#endif
#endif
...
#ifndef UNLINK
#define UNLINK ifdef(win32, _unlink, unlink)
#endif
