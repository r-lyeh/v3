...
#elif TRAY_APPKIT
  #define TRAY_ICON1 "icons/icon.png"
  #define TRAY_ICON2 "icons/icon.png"
#elif TRAY_WINAPI
  #define TRAY_ICON1 "icons/icon.ico"  ///< Path to first icon.
  #define TRAY_ICON2 "icons/icon.ico"  ///< Path to second icon.
#endif
