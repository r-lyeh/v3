...
#define cast(type,...)  ( (ifdef(V3_C,(type),type){__VA_ARGS__}) )
#define make(type,...)  ( cast(type, ( (void)sizeof(char [ offsetof(type,vt) == 0 ? 1 : -1 ]), (void*)((uintptr_t)type##_vt | 0) ), ##__VA_ARGS__))
#define heap(type,...)  ( (type*)memcpy(malloc(sizeof(type)), &cast(type, ( (void)sizeof(char [ offsetof(type,vt) == 0 ? 1 : -1 ]), (void*)((uintptr_t)type##_vt | 1) ), ##__VA_ARGS__), sizeof(type)))
