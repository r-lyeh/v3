...
enum {
  ...
  MU_ICON_ATLAS,
  MU_ICON_MAX,
  MU_ICON_CHEVRON_RIGHT = MU_ICON_COLLAPSED,
  MU_ICON_CHEVRON_DOWN = MU_ICON_EXPANDED,
#else
  MU_ICON_MAX
#endif
};
...
typedef struct { mu_BaseCommand base; mu_Rect dst, src; void* framebuffer; } mu_ImageCommand;
...
typedef struct {
  ...
  int zindex;
  int open;
  int minimized; //< @r-lyeh, used by our backend
} mu_Container;
...
void mu_draw_image(mu_Context *ctx, mu_Rect dst, mu_Rect src, void* texture_handle);
