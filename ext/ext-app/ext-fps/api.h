double fps(void);           // return frames per second
double spf(void);           // return seconds per frame

void   vsync(float hz);     // config frequency: -1: use monitor refresh rate, 0: vsync off, 1: vsync on, N: specific fps
float  hz(void);            // return configured frequency
