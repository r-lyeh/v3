...
scenegraph_t* sg_build(int scene_w, int scene_h)
{
    ...
    // Load texture
    pg_texture_t* bg_tex = load_texture("space.pug");
    ...
    pg_texture_t* star_tex = load_texture("star.pug");
    ...
    pg_texture_t* ship_tex = load_texture("ship.pug");
    ...
    pg_texture_t* jet_tex = load_texture("jet.pug");
