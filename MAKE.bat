...
[ ! -f ".setup" ] && [ -x "$(command -v apt-get)" ] && sudo apt-get -y update && sudo apt-get -y install gcc libx11-dev libgl1-mesa-dev mesa-common-dev libxrandr-dev libxcursor-dev libxi-dev libasound2-dev && echo>.setup

# compile --------------------------------------------------------------------
echo cc hello.c -o hello.linux -O1 -DNDEBUG=1 -lm -ldl -lasound -lpthread -g -Wno-unused-result $* || exit
     cc hello.c -o hello.linux -O1 -DNDEBUG=1 -lm -ldl -lasound -lpthread -g -Wno-unused-result $* || exit
...
echo cc -ObjC hello.c -o hello.osx -O1 -DNDEBUG=1 -framework cocoa -framework iokit -framework CoreFoundation -framework CoreAudio -framework Audiotoolbox -framework OpenGL -ldl -lm -g -Wno-unused-result $* || exit
     cc -ObjC hello.c -o hello.osx -O1 -DNDEBUG=1 -framework cocoa -framework iokit -framework CoreFoundation -framework CoreAudio -framework Audiotoolbox -framework OpenGL -ldl -lm -g -Wno-unused-result $* || exit
...
if "%1"=="embed" (
    ...
    echo #include "ext/ext-embed/3rd/xincbin.h"> v3/v3.rc
    ...
    where /q rc.exe && (rc /nologo v3/v3.rc || goto error)
